    ...
    create table core.countries (
       c_id  serial not null,
        c_iso varchar(255) not null,
        c_iso3 varchar(255),
        c_name varchar(255) not null,
        c_nicename varchar(255) not null,
        c_numcode int4,
        c_phonecode int4,
        primary key (c_id)
    )
    ...
    create table core.places (
       pk varchar(255) not null,
        ...
        p_latitude float8 not null,
        p_longitude float8 not null,
    ...
    create table core.processResources (
       pk varchar(255) not null,
        ...
        r_resource_content varchar(255) not null,
        r_resource_name varchar(255) not null,
        pr_latest_date_imported timestamp not null,
        pr_latest_date_processed timestamp not null,
        pr_process_pk varchar(255),
        pr_resource_import_version int4 not null,
        primary key (pk)
    )
    ...
    create table core.reviews (
       pk varchar(255) not null,
        ...
        r_rate float8 check (r_rate>=0 AND r_rate<=5),
        r_summary varchar(255),
        r_origin_pk varchar(255),
        r_place_pk varchar(255),
        r_user_pk varchar(255),
        primary key (pk)
    )
    ...
    create table core.taskResources (
       pk varchar(255) not null,
        ...
        r_resource_content varchar(255) not null,
        r_resource_name varchar(255) not null,
        tr_latest_date_imported timestamp not null,
        tr_latest_date_processed timestamp not null,
        tr_resource_import_version int4 not null,
    ...
    create table core.yelpPlacesRaw (
       ypr_id varchar(255) not null,
        ...
        ypr_latitude float8,
        ypr_longitude float8,
        ypr_name varchar(255),
        ypr_postalCode varchar(255),
        ypr_reviewCount float8,
        ypr_stars float8,
        ypr_state varchar(255),
        ypr_yelp_import_pk int4 not null,
    ...
    create table core.yelpReviewsRaw (
       yrr_id varchar(255) not null,
        ...
        yrr_yelp_import_pk int4 not null,
    ...
    create table core.yelpUsersRaw (
       yur_id varchar(255) not null,
        ...
        yur_reviewCount int4,
        yur_yelpingSince varchar(255),
        yur_yelp_import_pk int4 not null,
...
create index c_iso_idx on core.countries (c_iso)

    alter table core.countries 
       add constraint c_iso_unq_constraint unique (c_iso)
...
create index d_name_idx on core.divisions (d_name)
...
create index tp_code_idx on core.tasksParameters (tp_code)
    ...
    alter table core.addresses 
       add constraint FKa4ff72f0678w6t751jm4axdcx 
       foreign key (a_city_id) 
       references core.cities

    alter table core.categoryToPlacesRel 
       add constraint FKdvh1jql5sjrns7mxbrgxfvnp5 
       foreign key (ctp_category_pk) 
       references core.places

    alter table core.categoryToPlacesRel 
       add constraint FKddu4gpgyvp7n4obn8uh2cckas 
       foreign key (ctp_place_pk) 
       references core.categories

    alter table core.cities 
       add constraint FKila2hxqgfdx6db0suy746kbe0 
       foreign key (c_division_id) 
       references core.divisions
    ...
    alter table core.divisions 
       add constraint FKjj059fbx608p8ur1ok00mlmjb 
       foreign key (d_country_id) 
       references core.countries

    alter table core.places 
       add constraint FKot25a13cif7gkfpp1ctq8x4w0 
       foreign key (p_address_pk) 
       references core.addresses

    alter table core.places 
       add constraint FKbtkwhdlqw0581saw2t2i81en9 
       foreign key (p_origin) 
       references core.origins
    ...
    alter table core.processResources 
       add constraint FKshu8ujv75iy4mjmvtnrbj6n14 
       foreign key (pr_resource_import_version) 
       references core.resourceImports
    ...
    alter table core.reviews 
       add constraint FKjjg68q7jbqi5j1mubkds84qt3 
       foreign key (r_origin_pk) 
       references core.origins

    alter table core.reviews 
       add constraint FKh8r0rhurucnv27v5b63r8g8yt 
       foreign key (r_place_pk) 
       references core.places

    alter table core.reviews 
       add constraint FKo6krfhjn9npej79j911tx238f 
    ...
    alter table core.taskResources 
       add constraint FK3pepu79vknxk6644rxvgm4hjp 
    ...
    alter table core.users 
       add constraint FKke56gx9k1km869qtxvvvb2f6y 
       foreign key (u_origin_pk) 
       references core.origins

    alter table core.yelpPlacesRaw 
       add constraint FKrfopoiaebvf8407m1lhsmig5j 
       foreign key (ypr_yelp_import_pk) 
       references core.yelpImports

    alter table core.yelpReviewsRaw 
       add constraint FKqcq2hsl73dp996ptksay9905j 
       foreign key (yrr_yelp_import_pk) 
       references core.yelpImports

    alter table core.yelpUsersRaw 
       add constraint FK6ej31w6u30m6xravy71jbqtkt 
