...
create table core.processResources (
                                       ...
                                       createdAt timestamp not null,
                                       updatedAt timestamp not null,
                                       pr_resource varchar(255) not null,
...
create table core.taskResources (
                                    ...
                                    createdAt timestamp not null,
                                    updatedAt timestamp not null,
                                    tr_resource varchar(255) not null,
...
create index tp_code_idx on core.tasksParameters (tp_code)
    ...
    create table core.division (
       d_id varchar(255) not null,
        ...
        d_country_id varchar(255) not null,
        primary key (d_id)
    )
...
create index c_code_idx on core.conditions (c_code)
    ...
    alter table core.conditions 
       add constraint c_code_unq_constraint unique (c_code)
create index c_iso_idx on core.country (c_iso)
    ...
    alter table core.delegatingTaskParameterValues 
       add constraint dtpv_processStep_parameter_unq_constraint unique (dtpv_processStep_pk, dtpv_taskParameter_pk)
create index d_name_idx on core.division (d_name)
...
create index tp_code_idx on core.tasksParameters (tp_code)
    ...
    alter table core.division 
       add constraint FKj3ar1dw9pw4uvk8cp54i5974h 
       foreign key (d_country_id) 
       references core.country
...
create index tp_code_idx on core.tasksParameters (tp_code)
    ...
    alter table core.city 
       add constraint FK5cm1yxl1k4i0xmy9sarttvdfu 
       foreign key (c_division_id) 
       references core.division
